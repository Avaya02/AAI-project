...
//   if (action === "deleteAll") {
//     // Handle delete all trashed tasks
//     await Task.deleteMany({ trashed: true });
//     return res.status(200).json({ message: "All trashed tasks deleted." });
//   } else if (action === "restoreAll") {
//     // Handle restore all trashed tasks
//     await Task.updateMany({ trashed: true }, { trashed: false });
//     return res.status(200).json({ message: "All trashed tasks restored." });
//   } else if (action === "delete") {
//     // Handle delete single task
//     await Task.findByIdAndDelete(id);
//     return res.status(200).json({ message: "Task deleted." });
//   } else if (action === "restore") {
//     // Handle restore single task
//     await Task.findByIdAndUpdate(id, { trashed: false });
